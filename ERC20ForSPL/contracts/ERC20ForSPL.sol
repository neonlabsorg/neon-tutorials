...
/// @notice This contract serve as an interface contract of already deployed SPLToken on Solana. Thru this interface Ethereum-like address on Neon EVM chain can apply changes on SPLToken account on Solana.
