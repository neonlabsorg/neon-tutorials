...
const createMarket = async () => {
    ...
    let info = await raydium.token.getTokenInfo('37jexVqVGrrT7erf7wSHTar5NJCvZTQ6otjgarffNNfX')
    console.log(info, 'TRT mint info')
    ...
    const { execute, extInfo, transactions } = await raydium.marketV2.create({
        baseInfo: {
            // TRT token
            mint: new PublicKey("37jexVqVGrrT7erf7wSHTar5NJCvZTQ6otjgarffNNfX"),
            decimals: 9,
        },
        quoteInfo: {
